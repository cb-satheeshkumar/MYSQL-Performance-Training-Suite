...
Question_Queries=[
    ...
    "Display sno, fname, lname, age, gender, marital_status, ctime, mtime of patients whose first name is Marion ordered by last name in ascending and age in descending order?",
    "Display sno, fname, lname, age, gender, marital_status, ctime, mtime of the first 20 patients whose first name is Marion ordered by age in descending order?",
    ...
    "Display sno, fname, lname, age, gender, marital_status, ctime, mtime of first 5000 patients who are not married and have ctime higher than 2020/01/01 and first name is 'Alex'?",
    ...
    "Display sno, email, phone_number, ctime, mtime of patients whose serial number is 9999975, phone number is (726) 238-9825 and email id is 'pij@darefhaf.lb'?",
    "Display sno, fname, lname, age, gender, marital_status, ctime, mtime of patients with first name starting with Al and last name as 'Taylor'?",
    ...
    "Display sno, fname, lname, age, gender, marital_status, ctime, mtime of patients whose first name or last name is either 'Alice' or 'Parker' ?"
      ]
#List of Hints
Hints=[
...
16:['fname','age'],
17:[],
18:['marital_status','fname'],
19:['marital_status','fname','ctime'],
20:['age'],
21:['age','lname'],
22:['sno','phone_number','email'],
23:['lname','fname'],
24:['state','ctime'],
25:['fname','sno'],
26:['lname','sno','sno'],
...
index_queries={
  ...
  21:['show index from personal_info;'],
